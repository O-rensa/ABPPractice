...
export class EmployeeServiceProxy {
     ...
     * @return Success
     */
    getEmployeeById(input: number | undefined): Observable<EmployeeDto> {
     ...
     * @return Success
     */
    create(body: EmployeeDto | undefined): Observable<number> {
     ...
     * @return Success
     */
    update(body: EmployeeDto | undefined): Observable<number> {
